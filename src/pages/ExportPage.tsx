...
import { Download, FileText, Image, Printer, ArrowLeft, Share2, Edit3 } from 'lucide-react';
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-teal-50 to-blue-50 rounded-lg border border-teal-200">
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-teal-900">Total Area:</span>
                  <span className="text-xl font-bold text-teal-900">{plan.totalArea}</span>
                </div>
              </div>
            </div>
          </div>
